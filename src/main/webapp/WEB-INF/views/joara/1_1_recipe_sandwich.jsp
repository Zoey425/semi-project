<%@ page language="java" contentType="text/html; charset=UTF-8"
   ...
   <article0><a href='cake.do?category=케이크'><img src="resources/image/cake2.png" style="width: 60%;"></a></article0>
    <article0><a href='sandwich.do?category=샌드위치'><img src="resources/image/sandwich3.png" style="width: 60%;"></a></article0> 
...
<hr width="60%">
 ...
 <c:choose>
    <c:when test="${empty newRes }">
     ...
     <c:otherwise>
    <c:forEach var="newDto" items="${newRes }" begin="0" end="5" step="1">
